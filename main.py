...
mlp.add_layer("first_hidden_layer", 300, activation_function="sigmoid", init_method="he")
mlp.add_layer("second_hidden_layer", 100, activation_function="relu", init_method="he")
mlp.add_layer("second_hidden_layer", 50, activation_function="tanh", init_method="he")
